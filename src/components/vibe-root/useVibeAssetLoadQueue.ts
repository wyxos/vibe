...
export function createVibeAssetLoadQueue(limits: VibeAssetLoadQueueLimits = DEFAULT_LIMITS) {
...
export const defaultVibeAssetLoadQueue = createVibeAssetLoadQueue()
