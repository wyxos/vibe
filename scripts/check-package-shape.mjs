...
try {
  ...
  const requiredEntries = [
    ...
    'package/lib/components/Masonry.vue.d.ts',
    'package/lib/components/MasonryItem.vue.d.ts',
    'package/lib/components/MasonryLoader.vue.d.ts',
    'package/lib/components/MasonryVideoControls.vue.d.ts',
    'package/lib/components/masonryItemRegistry.d.ts',
    'package/lib/masonry/backfill.d.ts',
    'package/lib/masonry/layout.d.ts',
    'package/lib/masonry/layoutEngine.d.ts',
