...
function Ae(e, l, i, a = {}) {
  ...
  const h = (s || 0) + T, P = (w || 0) + y, L = l.offsetWidth - l.clientWidth, f = L > 0 ? L + 2 : It() + 2, r = l.offsetWidth - f - h - P, u = g * (i - 1), I = Math.floor((r - u) / i), M = e.map((k) => {
    const B = k.width, R = k.height;
    return Math.round(I * R / B) + o + v;
  });
  if (x === "sequential-balanced") {
    ...
    for (let b = k - 1; b >= 0; b--) {
      const E = M[b], O = b < p;
      !(B(S, N, E) <= H) || O ? (n[p] = b + 1, p--, S = E, N = 1) : (S = B(S, N, E), N++);
    }
    n[0] = 0;
    const V = [], Y = new Array(i).fill(0);
    for (let b = 0; b < i; b++) {
      const E = n[b], O = b + 1 < i ? n[b + 1] : k, ne = b * (I + g);
      for (let X = E; X < O; X++) {
        const K = {
          ...e[X],
          columnWidth: I,
  ...
  for (let k = 0; k < e.length; k++) {
    ...
    R.columnWidth = I, R.left = $ * (I + g), R.imageHeight = Math.round(I * H / W), R.columnHeight = R.imageHeight + o + v, R.top = m[$], m[$] += R.columnHeight + d, z.push(R);
  }
  return z;
}
...
function Wt(e) {
  return e == null ? e === void 0 ? Bt : Dt : Ve && Ve in Object(e) ? Ht(e) : Nt(e);
}
function Ft(e) {
...
function Ue(e, l, i) {
  ...
  function y(m) {
    var z = a, k = g;
    return a = g = void 0, w = m, v = e.apply(k, z), v;
  }
  function h(m) {
    return w = m, o = setTimeout(f, l), t ? y(m) : v;
  }
  function P(m) {
    var z = m - s, k = m - w, B = l - z;
    return x ? Jt(B, d - k) : B;
  }
  function L(m) {
    var z = m - s, k = m - w;
    return s === void 0 || z >= l || z < 0 || x && k >= d;
  }
  function f() {
    var m = Se();
    if (L(m))
...
function ta(e, l) {
  ...
  function d(t, x) {
    ...
    if (T) {
      const P = T.scrollTop, L = T.clientHeight;
      i = P - g, a = P + L + g;
    }
    return t + x >= i && t <= a;
  }
  function v(t, x) {
    ...
    const L = Math.min(h * 20, 160), f = t.style.getPropertyValue("--masonry-opacity-delay");
  ...
  function w(t, x) {
    ...
    let L = Number.isFinite(P) && P > 0 ? P : Number.NaN;
    if (!Number.isFinite(L)) {
      const z = getComputedStyle(t).getPropertyValue("--masonry-leave-duration") || "", k = parseFloat(z);
      L = Number.isFinite(k) && k > 0 ? k : 200;
    }
    const f = t.style.transitionDuration, r = () => {
      t.removeEventListener("transitionend", u), clearTimeout(I), t.style.transitionDuration = f || "";
    }, u = (m) => {
      (!m || m.target === t) && (r(), x());
    }, I = setTimeout(() => {
      r(), x();
    }, L + 100);
    t.style.transitionDuration = `${L}ms`, t.style.opacity = "0", t.style.transform = `translate3d(${T}px, ${y + 10}px, 0) scale(0.985)`, t.addEventListener("transitionend", u);
  }
  return {
    onEnter: v,
    onBeforeEnter: o,
...
function aa({
  ...
  async function x(T, y = !1) {
    if (!e.value) return;
    const h = T ?? $e(l.value, i.value), P = h.length ? Math.max(...h) : 0, L = e.value.scrollTop + e.value.clientHeight, f = e.value.scrollTop > t + 1;
    t = e.value.scrollTop;
...
function na(e) {
  ...
  function f() {
    ...
    o.value++, L(), o.value >= i.value.length - 5 && g();
  }
  function r() {
    P.value && (o.value--, L());
  }
  ...
  function M($) {
    ...
    Math.abs(W) > 100 ? W > 0 && P.value ? r() : W < 0 && h.value ? f() : L() : L(), $.preventDefault();
  }
  function m($) {
  ...
  function B() {
    !l.value && o.value > 0 && (o.value = 0, s.value = 0), l.value && i.value.length === 0 && !a.value && d(v.value[0]), l.value && L();
  }
  function R() {
...
function la(e) {
  ...
  function M(H, n) {
    return new Promise((p) => {
      const S = Math.max(0, H | 0), N = Date.now();
      n(S, S);
      const V = setInterval(() => {
        if (r.value) {
          clearInterval(V), p();
        ...
        const Y = Date.now() - N, b = Math.max(0, S - Y);
  ...
  async function m(H) {
    ...
    for (; ; )
      try {
        const N = await H();
        return n > 0 && f("retry:stop", { attempt: n, success: !0 }), N;
      } catch (N) {
        if (n++, n > p)
          throw f("retry:stop", { attempt: n - 1, success: !1 }), N;
    ...
    if (!(a.value.length >= p)) {
      ...
      try {
        ...
        for (f("backfill:start", {
          ...
          currentPage: V,
          nextPage: Y
        }); a.value.length < p && N < P && s.value[s.value.length - 1] != null && !r.value && !d.value && u; ) {
        ...
        u = !1, g.value = !1;
        const N = o.value, V = s.value[s.value.length - 1];
        f("loading:stop", {
          fetched: a.value.length,
          currentPage: N,
          nextPage: V
  ...
  async function R() {
    if (!g.value && !d.value) {
      ...
      try {
        ...
        if (r.value) return;
        if (y === "refresh" && o.value != null && I(o.value) < L) {
          const N = await m(() => l(o.value, i == null ? void 0 : i.value));
          if (r.value) return;
          const V = [...a.value], Y = N.items.filter((E) => !E || E.id == null || E.page == null ? !1 : !V.some((O) => O && O.id === E.id && O.page === E.page));
          if (Y.length > 0) {
            const E = [...a.value, ...Y];
...
function oa(e) {
  ...
  async function T(f) {
    ...
    const r = new Set(f.map((I) => I.id)), u = l.value.filter((I) => !r.has(I.id));
  ...
  async function h(f, r) {
    if (!f) return;
    const u = l.value;
    if (u.findIndex((z) => z.id === f.id) !== -1) return;
  ...
  async function P(f, r) {
    ...
    const u = l.value, I = new Set(u.map((W) => W.id)), M = [];
    for (let W = 0; W < f.length; W++)
      I.has(($ = f[W]) == null ? void 0 : $.id) || M.push({ item: f[W], index: r[W] });
    if (M.length === 0) return;
    const m = /* @__PURE__ */ new Map();
    for (const { item: W, index: H } of M)
      m.set(H, W);
    const z = M.length > 0 ? Math.max(...M.map(({ index: W }) => W)) : -1, k = Math.max(u.length - 1, z), B = [];
    let R = 0;
    for (let W = 0; W <= k; W++)
...
function ra(e) {
  ...
  function T(P) {
    ...
    if (w(P, "refreshLayout"), P.length > 1e3 && t.length > P.length && t.length - P.length < 100) {
      ...
      for (let m = 0; m < P.length; m++)
        if (((u = P[m]) == null ? void 0 : u.id) !== ((I = t[m]) == null ? void 0 : I.id)) {
          M = !1;
          break;
        }
      if (M) {
    ...
    if (s.value && s.value.width !== void 0) {
      ...
      const z = Ae(f, r, g.value, o.value);
      r.style.width = M, r.style.boxSizing = m, x(z), l.value = z, t = z;
    } else {
  ...
  function y(P, L) {
    s.value = P, P && (P.width !== void 0 && (d.value = P.width), !i.value && a.value && l.value.length > 0 && C(() => {
      g.value = se(o.value, d.value), T(l.value), L && L();
    }));
  }
  function h() {
...
function ia(e) {
  const {
    ...
    const L = o.value - w, f = o.value + s.value + w, r = l.value;
    return !r || r.length === 0 ? [] : r.filter((I) => {
      if (typeof I.top != "number" || typeof I.columnHeight != "number")
        return !0;
      const M = I.top;
      return I.top + I.columnHeight >= L && M <= f;
    });
  });
  function y(L) {
    if (!i.value) return;
    const { scrollTop: f, clientHeight: r } = i.value, u = f + r, I = L ?? $e(l.value, a.value), M = I.length ? Math.max(...I) : 0, m = typeof d == "number" ? d : 200, z = m >= 0 ? Math.max(0, M - m) : Math.max(0, M + m), k = Math.max(0, z - u), B = k <= 100;
    x.value = {
...
const ua = { class: "flex-1 relative min-h-0" }, ca = { class: "w-full h-full rounded-xl overflow-hidden shadow-sm transition-all duration-300 bg-white relative" }, va = {
  ...
  setup(e, { emit: l }) {
    const i = e, a = l, g = F(!1), d = F(!1), v = F(null), o = F(!1), s = F(!1), w = F(null), t = F(!1), x = F(!1), T = F(!1), y = F(!1), h = F(!1), P = F(null), L = F(null);
    let f = null;
    const r = Q(() => {
      var n;
    ...
    function B(n) {
      const p = n.target;
      p && (I.value || p.play(), m("video"));
    }
    function R(n) {
      const p = n.target;
      p && (I.value || p.pause(), z("video"));
    }
    function $(n) {
      return new Promise((p, S) => {
        ...
        const N = new Image(), V = Date.now(), Y = 300;
        N.onload = () => {
    ...
    function W(n) {
      return new Promise((p, S) => {
        ...
        const N = document.createElement("video"), V = Date.now(), Y = 300;
    ...
    return Ge(async () => {
      if (!P.value) return;
      const n = [i.preloadThreshold, 1].filter((S, N, V) => V.indexOf(S) === N).sort((S, N) => S - N);
      f = new IntersectionObserver(
        (S) => {
          S.forEach((N) => {
            const V = N.intersectionRatio, Y = V >= 1, b = V >= i.preloadThreshold;
            if (Y && !x.value) {
              x.value = !0, a("in-view", { item: i.item, type: r.value });
              const E = r.value === "image" ? v.value : w.value, O = r.value === "image" ? g.value : o.value;
              E && O && M(r.value, E);
            }
            b && !t.value ? (t.value = !0, H()) : N.isIntersecting;
          });
        },
        {
      ...
      function p() {
        ...
        const S = P.value.getBoundingClientRect(), N = window.innerHeight, V = window.innerWidth;
        if (S.top >= 0 && S.bottom <= N && S.left >= 0 && S.right <= V && S.height > 0 && S.width > 0) {
          x.value = !0, a("in-view", { item: i.item, type: r.value });
      ...
      () => i.isActive,
      (n) => {
        !I.value || !L.value || (n ? L.value.play() : L.value.pause());
      }
    ), (n, p) => (_(), U("div", {
          ...
          G("div", ca, [
            u.value ? (_(), U("div", va, p[3] || (p[3] = [
              ...
              r.value === "image" && v.value ? (_(), U("img", {
                ...
                onMouseleave: p[1] || (p[1] = (S) => z("image"))
              }, null, 42, da)) : ae("", !0),
  ...
  setup(e, { expose: l, emit: i }) {
    ...
    }), r = F(7), u = F(null), I = F([]), M = F(null), m = F(!1), z = F(0), k = F(!1), B = F(null), R = F(!1), $ = Q(() => Kt(o.value)), W = sa({
      masonry: h
    ...
    }), { refreshLayout: S, setFixedDimensions: N, onResize: V } = p, Y = ia({
      masonry: h,
      container: u,
      columns: r,
    ...
    function ht(c) {
      N(c, X), !c && v.value && (o.value = v.value.clientWidth, s.value = v.value.clientHeight);
    }
    l({
    ...
    const ce = ee.currentSwipeIndex, pe = ee.swipeOffset, ye = ee.isDragging, oe = ee.swipeContainer, ze = ee.handleTouchStart, Ne = ee.handleTouchMove, De = ee.handleTouchEnd, Be = ee.handleMouseDown, Te = ee.handleMouseMove, Pe = ee.handleMouseUp, Ie = ee.snapToCurrentItem;
    function mt(c) {
    ...
    function bt() {
      Me(), u.value && u.value.scrollTo({
        top: 0,
        behavior: "smooth"
      }), h.value = [], s.value = 0, M.value = a.loadAtPage, I.value = [a.loadAtPage], k.value = !1, B.value = null, R.value = !1, K();
    }
    function Mt() {
      Me(), h.value = [], z.value = 0, M.value = null, I.value = [], k.value = !1, B.value = null, m.value = !1, R.value = !1, ce.value = 0, pe.value = 0, ye.value = !1, K(), n(), u.value && u.value.scrollTo({
        top: 0,
        behavior: "auto"
    ...
    async function Tt(c, D, j) {
      console.log("initialize", c, D, j), M.value = D, I.value = [D], j != null && I.value.push(j), console.log("paginationHistory", I.value), k.value = j === null, H(c, "initialize");
    ...
    return te(
      ...
      c && (c.addEventListener("touchstart", ze, { passive: !1 }), c.addEventListener("touchmove", Ne, { passive: !1 }), c.addEventListener("touchend", De), c.addEventListener("mousedown", Be));
      ...
      try {
        ...
        if (a.init === "auto" && I.value.length === 0 && (I.value = [c]), a.init === "auto") {
          R.value = !0, await C();
          try {
            await be(c);
          } catch {
      ...
      var c;
      t && (t.disconnect(), t = null), (c = u.value) == null || c.removeEventListener("scroll", re), window.removeEventListener("resize", We), window.removeEventListener("resize", Fe), oe.value && (oe.value.removeEventListener("touchstart", ze), oe.value.removeEventListener("touchmove", Ne), oe.value.removeEventListener("touchend", De), oe.value.removeEventListener("mousedown", Be)), document.removeEventListener("mousemove", Te), document.removeEventListener("mouseup", Pe);
    }), (c, D) => (_(), U("div", {
      ref_key: "wrapper",
      ref: v,
  ...
  for (const [a, g] of l)
    i[a] = g;
  return i;
}, _e = /* @__PURE__ */ Sa(ka, [["__scopeId", "data-v-85c07a1e"]]), Ha = {
  install(e) {
