import { nextTick as J, defineComponent as tt, ref as T, computed as Z, onMounted as at, onUnmounted as nt, watch as re, createElementBlock as D, openBlock as F, createCommentVNode as ne, createElementVNode as A, normalizeStyle as we, renderSlot as Q, normalizeClass as ue, withModifiers as Ue, toDisplayString as He, Fragment as _e, renderList as Ge, createVNode as $e, withCtx as ge, mergeProps as pe, TransitionGroup as Tt, unref as Lt } from "vue";
let Se = null;
function kt() {
...
function Xe(t, v, c, r = {}) {
  ...
  if (I === "sequential-balanced") {
    ...
    const P = n, O = new Array(c).fill(0);
    let _ = c - 1, C = 0, N = 0;
    for (let k = w - 1; k >= 0; k--) {
      const z = H[k], K = k < _;
      !(M(C, N, z) <= P) || K ? (O[_] = k + 1, _--, C = z, N = 1) : (C = M(C, N, z), N++);
    }
    O[0] = 0;
    const oe = [], ie = new Array(c).fill(0);
    for (let k = 0; k < c; k++) {
      const z = O[k], K = k + 1 < c ? O[k + 1] : w, G = k * (x + L);
      for (let X = z; X < K; X++) {
        const te = {
          ...t[X],
          columnWidth: x,
  ...
  for (let w = 0; w < t.length; w++) {
    const M = t[w], j = {
      ...
      left: 0,
      top: 0
    }, n = m.indexOf(Math.min(...m)), f = M.width, P = M.height;
    j.columnWidth = x, j.left = n * (x + L), j.imageHeight = Math.round(x * P / f), j.columnHeight = j.imageHeight + s + l, j.top = m[n], m[n] += j.columnHeight + p, B.push(j);
  }
  return B;
}
...
function Rt(t) {
  return typeof t == "symbol" || Ot(t) && zt(t) == At;
}
var jt = /\s/;
function Ct(t) {
...
var Ke = NaN, Vt = /^[-+]0x[0-9a-f]+$/i, Ut = /^0b[01]+$/i, _t = /^0o[0-7]+$/i, Gt = parseInt;
function Qe(t) {
  if (typeof t == "number")
    return t;
  if (Rt(t))
  ...
  t = qt(t);
  var c = Ut.test(t);
  return c || _t.test(t) ? Gt(t.slice(2), c ? 2 : 8) : Vt.test(t) ? Ke : +t;
}
var Pe = function() {
  return lt.Date.now();
...
function Ze(t, v, c) {
  ...
  function W(m) {
    var B = r, w = L;
    return r = L = void 0, E = m, l = t.apply(w, B), l;
  }
  function R(m) {
    return E = m, s = setTimeout(o, v), S ? W(m) : l;
  }
  function q(m) {
    var B = m - b, w = m - E, M = v - B;
    return I ? Kt(M, p - w) : M;
  }
  function g(m) {
    var B = m - b, w = m - E;
  ...
  function $(m) {
    return s = void 0, d && r ? W(m) : (r = L = void 0, l);
  }
  function y() {
...
const la = { class: "flex-1 relative min-h-0" }, ra = { class: "w-full h-full rounded-xl overflow-hidden shadow-sm transition-all duration-300 bg-white relative" }, oa = {
  ...
  setup(t, { emit: v }) {
    ...
    function w(n) {
      return new Promise((f, P) => {
        ...
        const O = new Image(), _ = Date.now(), C = 300;
        O.onload = () => {
          const N = Date.now() - _, oe = Math.max(0, C - N);
          setTimeout(async () => {
    ...
    function M(n) {
      return new Promise((f, P) => {
        ...
        const O = document.createElement("video"), _ = Date.now(), C = 300;
          ...
          A("div", ra, [
            o.value ? (F(), D("div", oa, f[3] || (f[3] = [
              ...
              g.value === "image" && p.value || g.value === "video" && b.value ? (F(), D("div", fa, [
                ...
                A("span", null, "Failed to load " + He(g.value), 1)
              ])) : ne("", !0)
            ]))
          ])
        ])
  ...
  setup(t, { expose: v, emit: c }) {
    ...
    }), $ = T(7), y = T(null), x = T([]), H = T(null), m = T(!1), B = T(0), w = T(!1), M = T(null), j = Z(() => Qt(s.value)), n = T(0), f = T(0), P = T(!1), O = T(0), _ = T(0), C = T(null), N = T(/* @__PURE__ */ new Set());
    function oe(e) {
    ...
    function ie(e, a) {
      try {
        ...
        for (const u of i) {
          ...
          N.value.has(Y) || (N.value.add(Y), h.push(Y));
        }
        if (h.length > 0) {
          const u = h.slice(0, 10);
          console.warn(
    ...
    const k = T(0), z = T(0), K = r.virtualBufferPx, G = T(!1), X = T({
      ...
      if (!y.value) return;
      const { scrollTop: a, clientHeight: i } = y.value, h = a + i, u = e ?? We(o.value, $.value), Y = u.length ? Math.max(...u) : 0, U = typeof r.loadThresholdPx == "number" ? r.loadThresholdPx : 200, ce = U >= 0 ? Math.max(0, Y - U) : Math.max(0, Y + U), Ve = Math.max(0, ce - h), Et = Ve <= 100;
      X.value = {
    ...
    const dt = Z(() => {
      ...
      return !i || i.length === 0 ? [] : i.filter((h) => {
        const u = h.top;
        return h.top + h.columnHeight >= e && u <= a;
      });
    }), { handleScroll: mt } = na({
      container: y,
      masonry: o,
    ...
    function De(e) {
      ...
      let i = 0;
      if (y.value) {
        const { scrollTop: h, clientHeight: u } = y.value;
        i = h + u + 100;
      }
    ...
    function ae(e) {
      ...
      if (E.value && E.value.width !== void 0) {
        const h = i.style.width, u = i.style.boxSizing;
        i.style.boxSizing = "border-box", i.style.width = `${E.value.width}px`, i.offsetWidth;
        const Y = Xe(a, i, $.value, p.value);
        i.style.width = h, i.style.boxSizing = u, De(Y), o.value = Y;
      } else {
        const h = Xe(a, i, $.value, p.value);
        De(h), o.value = h;
      }
    }
    function Fe(e, a) {
      return new Promise((i) => {
        const h = Math.max(0, e | 0), u = Date.now();
        a(h, h);
        const Y = setInterval(() => {
          if (V.value) {
            clearInterval(Y), i();
          ...
          const U = Date.now() - u, ce = Math.max(0, h - U);
          a(ce, h), ce <= 0 && (clearInterval(Y), i());
        }, 100);
      });
    }
    async function be(e) {
    ...
    async function gt(e) {
      ...
      for (; ; )
        try {
          ...
          g("retry:start", { attempt: a, max: i, totalMs: h }), await Fe(h, (Y, U) => {
            g("retry:tick", { attempt: a, remainingMs: Y, totalMs: U });
          }), h += r.retryBackoffStepMs;
        }
    }
    async function Ee(e) {
      if (!m.value) {
        V.value = !1, m.value = !0, w.value = !1, M.value = null;
        try {
    ...
    async function ve() {
      if (!m.value && !w.value) {
        V.value = !1, m.value = !0, M.value = null;
        try {
    ...
    async function pt(e) {
      ...
      const a = new Set(e.map((h) => h.id)), i = o.value.filter((h) => !a.has(h.id));
    ...
    async function he(e, a = !1) {
      ...
      if (!(o.value.length >= i)) {
        ...
        try {
          let u = 0;
          for (g("backfill:start", { target: i, fetched: o.value.length, calls: u }); o.value.length < i && u < r.backfillMaxCalls && x.value[x.value.length - 1] != null && !V.value && !w.value && (await Fe(r.backfillDelayMs, (U, ce) => {
            g("backfill:tick", {
            ...
            try {
              const U = await be(Y);
              if (V.value) break;
              M.value = null, x.value.push(U.nextPage), U.nextPage == null && (w.value = !0);
            } catch (U) {
              M.value = U instanceof Error ? U : new Error(String(U));
            }
            u++;
          }
    ...
    function xt() {
      Le(), o.value = [], B.value = 0, H.value = null, x.value = [], w.value = !1, M.value = null, m.value = !1, me = !1, V.value = !1, n.value = 0, f.value = 0, P.value = !1, k.value = 0, z.value = 0, G.value = !1, X.value = {
        distanceToTrigger: 0,
        isNearTrigger: !1
    ...
    function Oe(e) {
      d.value && (P.value = !0, O.value = e.touches[0].clientY, _.value = f.value, e.preventDefault());
    }
    function Ae(e) {
      if (!d.value || !P.value) return;
      const a = e.touches[0].clientY - O.value;
      f.value = _.value + a, e.preventDefault();
    }
    function Re(e) {
      if (!d.value || !P.value) return;
      P.value = !1;
      const a = f.value - _.value;
      Math.abs(a) > 100 ? a > 0 && q.value ? Ye() : a < 0 && R.value ? Ce() : le() : le(), e.preventDefault();
    }
    function je(e) {
      d.value && (P.value = !0, O.value = e.clientY, _.value = f.value, e.preventDefault());
    }
    function ke(e) {
      if (!d.value || !P.value) return;
      const a = e.clientY - O.value;
      f.value = _.value + a, e.preventDefault();
    }
    function Ie(e) {
      if (!d.value || !P.value) return;
    ...
    function qe() {
      !d.value && n.value > 0 && (n.value = 0, f.value = 0), d.value && o.value.length === 0 && !m.value && Ee(x.value[0]), d.value && le();
    }
    function Mt(e, a, i) {
    ...
    return re(
      ...
      e && (e.addEventListener("touchstart", Oe, { passive: !1 }), e.addEventListener("touchmove", Ae, { passive: !1 }), e.addEventListener("touchend", Re), e.addEventListener("mousedown", je));
      ...
      S && (S.disconnect(), S = null), e && typeof ResizeObserver < "u" ? (S = new ResizeObserver((a) => {
        if (!E.value)
          for (const i of a) {
            const h = i.contentRect.width, u = i.contentRect.height;
            s.value !== h && (s.value = h), b.value !== u && (b.value = u);
          }
      ...
      var e;
      S && (S.disconnect(), S = null), (e = y.value) == null || e.removeEventListener("scroll", se), window.removeEventListener("resize", ze), window.removeEventListener("resize", qe), C.value && (C.value.removeEventListener("touchstart", Oe), C.value.removeEventListener("touchmove", Ae), C.value.removeEventListener("touchend", Re), C.value.removeEventListener("mousedown", je)), document.removeEventListener("mousemove", ke), document.removeEventListener("mouseup", Ie);
    }), (e, a) => (F(), D("div", {
      ref_key: "wrapper",
      ref: l,
      ...
      d.value ? (F(), D("div", {
        ...
        A("div", {
          ...
          (F(!0), D(_e, null, Ge(o.value, (i, h) => (F(), D("div", {
            key: `${i.page}-${i.id}`,
            ...
            A("div", da, [
              A("div", ma, [
                Q(e.$slots, "default", {
                  item: i,
                  remove: de,
                  index: i.originalIndex ?? r.items.indexOf(i)
                }, () => [
                  $e(Me, {
                    item: i,
                    remove: de,
        ...
        w.value && o.value.length > 0 ? (F(), D("div", ha, [
          Q(e.$slots, "end-message", {}, () => [
            a[8] || (a[8] = A("p", { class: "text-gray-500 dark:text-gray-400" }, "You've reached the end", -1))
          ], !0)
        ])) : ne("", !0),
        M.value && o.value.length > 0 ? (F(), D("div", ga, [
          Q(e.$slots, "error-message", { error: M.value }, () => [
            A("p", pa, "Failed to load content: " + He(M.value.message), 1)
          ], !0)
        ])) : ne("", !0)
      ], 2)) : (F(), D("div", {
        key: 1,
        ...
        A("div", {
          ...
          $e(Tt, {
            ...
            default: ge(() => [
              (F(!0), D(_e, null, Ge(dt.value, (i, h) => (F(), D("div", pe({
                key: `${i.page}-${i.id}`,
                ...
                Q(e.$slots, "default", {
                  item: i,
                  remove: de,
                  index: i.originalIndex ?? t.items.indexOf(i)
                }, () => [
                  $e(Me, {
                    item: i,
                    remove: de,
        ...
        w.value && o.value.length > 0 ? (F(), D("div", ya, [
          Q(e.$slots, "end-message", {}, () => [
            a[9] || (a[9] = A("p", { class: "text-gray-500 dark:text-gray-400" }, "You've reached the end", -1))
          ], !0)
        ])) : ne("", !0),
        M.value && o.value.length > 0 ? (F(), D("div", wa, [
          Q(e.$slots, "error-message", { error: M.value }, () => [
            A("p", ba, "Failed to load content: " + He(M.value.message), 1)
          ], !0)
        ])) : ne("", !0)
      ], 2))
    ], 512));
  ...
  for (const [r, L] of v)
    c[r] = L;
  return c;
}, et = /* @__PURE__ */ Ma(xa, [["__scopeId", "data-v-fbdf397f"]]), Ta = {
  install(t) {
