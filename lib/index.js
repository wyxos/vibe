...
function Ve(e, n, s, a = {}) {
  ...
  const h = (i || 0) + I, L = (M || 0) + x, S = n.offsetWidth - n.clientWidth, d = S > 0 ? S + 2 : kt() + 2, c = n.offsetWidth - d - h - L, r = m * (s - 1), b = Math.floor((c - r) / s), P = e.map((k) => {
  ...
  if (T === "sequential-balanced") {
    ...
    for (let w = 0; w < s; w++) {
      const F = o[w], B = w + 1 < s ? o[w + 1] : k, Y = w * (b + m);
      for (let q = F; q < B; q++) {
        const G = {
          ...e[q],
          columnWidth: b,
  ...
  for (let k = 0; k < e.length; k++) {
    ...
    W.columnWidth = b, W.left = E * (b + m), W.imageHeight = Math.round(b * Z / z), W.columnHeight = W.imageHeight + l + f, W.top = p[E], p[E] += W.columnHeight + g, D.push(W);
  }
  return D;
}
...
function Nt(e) {
  ...
  var m = $t.call(e);
  return a && (n ? e[de] = s : delete e[de]), m;
}
var zt = Object.prototype, Dt = zt.toString;
function Bt(e) {
  return Dt.call(e);
}
var Wt = "[object Null]", Rt = "[object Undefined]", je = we ? we.toStringTag : void 0;
function Ft(e) {
  return e == null ? e === void 0 ? Rt : Wt : je && je in Object(e) ? Nt(e) : Bt(e);
}
function Ct(e) {
...
function _e(e, n, s) {
  ...
  function c(p) {
    return l = void 0, I && a ? x(p) : (a = m = void 0, f);
  }
  function r() {
    l !== void 0 && clearTimeout(l), M = 0, a = i = m = l = void 0;
  }
  function b() {
...
function Ne(e, n) {
  ...
  const a = Array.from(new Set(e.map((f) => f.left))).sort((f, l) => f - l).slice(0, n), m = /* @__PURE__ */ new Map();
  for (let f = 0; f < a.length; f++) m.set(a[f], f);
  const g = new Array(a.length).fill(0);
  for (const f of e) {
    const l = m.get(f.left);
...
function na(e, n) {
  ...
  function g(t, T) {
    var h;
    const I = (h = e.container) == null ? void 0 : h.value;
    if (I) {
  ...
  function f(t, T) {
    var r;
    const I = parseInt(t.dataset.left || "0", 10), x = parseInt(t.dataset.top || "0", 10), h = parseInt(t.dataset.index || "0", 10), L = t.offsetHeight || parseInt(getComputedStyle(t).height || "200", 10) || 200;
    ...
    const S = Math.min(h * 20, 160), d = t.style.getPropertyValue("--masonry-opacity-delay");
  ...
  function M(t, T) {
    var P;
    const I = parseInt(t.dataset.left || "0", 10), x = parseInt(t.dataset.top || "0", 10), h = t.offsetHeight || parseInt(getComputedStyle(t).height || "200", 10) || 200;
...
function la({
  ...
  async function T(I, x = !1) {
    if (!e.value) return;
    const h = I ?? Ne(n.value, s.value), L = h.length ? Math.max(...h) : 0, S = e.value.scrollTop + e.value.clientHeight, d = e.value.scrollTop > t + 1;
    t = e.value.scrollTop;
...
function oa(e) {
  const { useSwipeMode: n, masonry: s, isLoading: a, loadNext: m, loadPage: g, paginationHistory: f } = e, l = N(0), i = N(0), M = N(!1), t = N(0), T = N(0), I = N(null), x = Q(() => {
  ...
  function d() {
    ...
    l.value++, S(), l.value >= s.value.length - 5 && m();
  }
  function c() {
    L.value && (l.value--, S());
  }
  ...
  function P(E) {
    ...
    Math.abs(z) > 100 ? z > 0 && L.value ? c() : z < 0 && h.value ? d() : S() : S(), E.preventDefault();
  }
  function p(E) {
...
function ra(e) {
  ...
  async function H(o, v = !1) {
    ...
    if (!(a.value.length >= y)) {
      b = !0, m.value || (m.value = !0, d("loading:start"));
      try {
        let O = 0;
  ...
  async function W(o) {
    if (!m.value) {
      r.value = !1, m.value || (m.value = !0, d("loading:start")), g.value = !1, f.value = null;
      try {
  ...
  async function E() {
    if (!m.value && !g.value) {
      r.value = !1, m.value || (m.value = !0, d("loading:start")), f.value = null;
      try {
  ...
  async function z() {
    if (!m.value) {
      r.value = !1, m.value = !0, d("loading:start");
      try {
        const o = l.value;
        if (o == null) {
...
function sa(e) {
  ...
  function I(L) {
    ...
    if (i.value && i.value.width !== void 0) {
      ...
      const D = Ve(d, c, m.value, l.value);
      c.style.width = P, c.style.boxSizing = p, T(D), n.value = D, t = D;
    } else {
      const P = Ve(d, c, m.value, l.value);
      T(P), n.value = P, t = P;
    }
  }
  function x(L, S) {
    i.value = L, L && (L.width !== void 0 && (g.value = L.width), !s.value && a.value && n.value.length > 0 && C(() => {
      m.value = se(l.value, g.value), I(n.value), S && S();
    }));
  }
  function h() {
    m.value = se(l.value, g.value), I(n.value);
  }
  return {
    refreshLayout: I,
...
function ua(e) {
  const {
    ...
    virtualBufferPx: m,
    loadThresholdPx: g
  } = e, f = N(e.handleScroll), l = N(0), i = N(0), M = m, t = N(!1), T = N({
    distanceToTrigger: 0,
    isNearTrigger: !1
  }), I = Q(() => {
...
const va = { class: "flex-1 relative min-h-0" }, fa = { class: "w-full h-full rounded-xl overflow-hidden shadow-sm transition-all duration-300 bg-white relative" }, da = {
  ...
  setup(e, { emit: n }) {
    const s = e, a = n, m = N(!1), g = N(!1), f = N(null), l = N(!1), i = N(!1), M = N(null), t = N(!1), T = N(!1), I = N(!1), x = N(!1), h = N(!1), L = N(null), S = N(null);
    let d = null;
    const c = Q(() => {
      var o;
    ...
    function P(o, v) {
      const y = o === "image" ? m.value : l.value;
    ...
    function E(o) {
      return new Promise((v, y) => {
        ...
        R.onload = () => {
          ...
          setTimeout(async () => {
            m.value = !0, g.value = !1, x.value = !1, await C(), await new Promise((B) => setTimeout(B, 100)), h.value = !0, a("preload:success", { item: s.item, type: "image", src: o }), P("image", o), v();
          }, F);
        }, R.onerror = () => {
          g.value = !0, m.value = !1, x.value = !1;
    ...
    function z(o) {
      return new Promise((v, y) => {
        ...
        R.preload = "metadata", R.muted = !0, R.onloadedmetadata = () => {
          const w = Date.now() - O, F = Math.max(0, j - w);
          setTimeout(async () => {
            l.value = !0, i.value = !1, x.value = !1, await C(), await new Promise((B) => setTimeout(B, 100)), h.value = !0, a("preload:success", { item: s.item, type: "video", src: o }), P("video", o), v();
          }, F);
        }, R.onerror = () => {
    ...
    async function Z() {
      var v;
      if (!t.value || x.value || r.value || c.value === "video" && l.value || c.value === "image" && m.value)
        return;
      const o = (v = s.item) == null ? void 0 : v.src;
      if (o)
        if (x.value = !0, h.value = !1, c.value === "video") {
    ...
    return qe(async () => {
        ...
        (y) => {
          y.forEach((R) => {
            ...
            if (j && !T.value) {
              ...
              const F = c.value === "image" ? f.value : M.value, B = c.value === "image" ? m.value : l.value;
              F && B && P(c.value, F);
            }
      ...
      function v() {
        ...
        if (y.top >= 0 && y.bottom <= R && y.left >= 0 && y.right <= O && y.height > 0 && y.width > 0) {
          T.value = !0, a("in-view", { item: s.item, type: c.value });
          const w = c.value === "image" ? f.value : M.value, F = c.value === "image" ? m.value : l.value;
          w && F && P(c.value, w);
        }
      }
    }), Je(() => {
      ...
      async (o) => {
        if (!(!o || r.value)) {
          ...
          } else if (o !== f.value && (m.value = !1, g.value = !1, f.value = o, t.value)) {
            x.value = !0;
            try {
              await E(o);
            } catch {
          ...
          X("div", fa, [
            r.value ? (_(), U("div", da, v[3] || (v[3] = [
              ...
              c.value === "video" && M.value ? (_(), U("video", {
                ...
                class: ie([
                  "w-full h-full object-cover transition-opacity duration-700 ease-in-out",
                  l.value && h.value ? "opacity-100" : "opacity-0"
                ]),
                style: { position: "absolute", top: "0", left: "0" },
                muted: "",
                loop: "",
              ...
              !m.value && !l.value && !g.value && !i.value ? (_(), U("div", {
                key: 2,
                class: ie([
  ...
  setup(e, { expose: n, emit: s }) {
    ...
    }), c = N(7), r = N(null), b = N([]), P = N(null), p = N(!1), D = N(0), k = N(!1), H = N(null), W = N(!1), E = Q(() => Zt(l.value)), z = ca({
      masonry: h
    }), { checkItemDimensions: Z, reset: o } = z, v = sa({
      masonry: h,
      useSwipeMode: I,
      container: r,
      columns: c,
    ...
    }), { refreshLayout: y, setFixedDimensions: R, onResize: O } = v, j = ua({
      masonry: h,
      container: r,
      columns: c,
    ...
    }), { viewportTop: w, viewportHeight: F, virtualizing: B, visibleMasonry: Y, updateScrollProgress: q, updateViewport: ne, reset: G } = j, { onEnter: be, onBeforeEnter: Ze, onBeforeLeave: et, onLeave: tt } = na(
      { container: r },
    ...
    function Tt() {
      Te(), r.value && r.value.scrollTo({
        top: 0,
        behavior: "smooth"
      }), h.value = [], i.value = 0, P.value = a.loadAtPage, b.value = [a.loadAtPage], k.value = !1, H.value = null, W.value = !1, G();
    }
    function Pt() {
      Te(), h.value = [], D.value = 0, P.value = null, b.value = [], k.value = !1, H.value = null, p.value = !1, W.value = !1, ce.value = 0, pe.value = 0, ye.value = !1, G(), o(), r.value && r.value.scrollTo({
        top: 0,
        behavior: "auto"
    ...
    async function It(u, $, V) {
      ...
      const le = h.value, A = le.length === 0 ? u : [...le, ...u];
      h.value = A, await C(), I.value ? ce.value === 0 && h.value.length > 0 && (pe.value = 0) : (await C(), await C(), y(A), r.value && (w.value = r.value.scrollTop, F.value = r.value.clientHeight || window.innerHeight), C(() => {
    ...
    return te(
      g,
      () => {
        I.value || r.value && (c.value = se(g.value, l.value), y(h.value));
      },
      { deep: !0 }
    ), te(() => a.layoutMode, () => {
      ...
      $ === void 0 && u === !1 || C(() => {
        u ? (document.addEventListener("mousemove", Pe), document.addEventListener("mouseup", Ie), r.value && r.value.removeEventListener("scroll", re), ce.value = 0, pe.value = 0, h.value.length > 0 && Le()) : (document.removeEventListener("mousemove", Pe), document.removeEventListener("mouseup", Ie), r.value && f.value && (M.value && M.value.width !== void 0 ? l.value = M.value.width : l.value = f.value.clientWidth, r.value.removeEventListener("scroll", re), r.value.addEventListener("scroll", re, { passive: !0 }), h.value.length > 0 && (c.value = se(g.value, l.value), y(h.value), w.value = r.value.scrollTop, F.value = r.value.clientHeight, q())));
      });
    }, { immediate: !0 }), te(oe, (u) => {
      ...
      u !== $ && u > 0 && !I.value && r.value && h.value.length > 0 && C(() => {
        c.value = se(g.value, u), y(h.value), q();
      });
    }), qe(async () => {
      try {
      ...
      W.value ? I.value ? (_(), U("div", {
        ...
        X("div", {
          ...
          (_(!0), U(Oe, null, Ae(h.value, (V, le) => (_(), U("div", {
            key: `${V.page}-${V.id}`,
            ...
            X("div", ba, [
              X("div", Ma, [
                K(u.$slots, "default", {
                  item: V,
                  remove: J(ue),
                  index: V.originalIndex ?? h.value.indexOf(V)
                }, () => [
                  ke(xe, {
                    item: V,
                    remove: J(ue),
  ...
  for (const [a, m] of n)
    s[a] = m;
  return s;
}, Xe = /* @__PURE__ */ Ha(Ea, [["__scopeId", "data-v-054307be"]]), Na = {
  install(e) {
