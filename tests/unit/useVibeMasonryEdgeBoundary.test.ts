...
import { useVibeMasonryEdgeBoundary, type VibeMasonryEdgeDirection } from '@/components/vibe-root/useVibeMasonryEdgeBoundary'

describe('useVibeMasonryEdgeBoundary', () => {
  beforeEach(() => {
    vi.useFakeTimers()
  })
...
async function mountEdgeBoundary(
  ...
  let api!: ReturnType<typeof useVibeMasonryEdgeBoundary>
  ...
  const app = createApp(defineComponent({
    setup() {
      api = useVibeMasonryEdgeBoundary({
        direction,
        getAnimationLockMs,
