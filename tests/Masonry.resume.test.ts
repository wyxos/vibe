...
import type { MasonryItemBase, MasonryResumeState } from '@/masonry/types'
...
describe('Masonry resume session', () => {
  it('does not load on mount and resumes from nextPage on scroll', async () => {
    ...
    const Harness = defineComponent({
      setup() {
        ...
        const resume: MasonryResumeState = {
          pagesLoaded: [1, 2, 3, 4, 5],
          nextPage: 6,
        }
